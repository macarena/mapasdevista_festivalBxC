			...
			<div class="content">
				<p class="metadata bottom">
					...
					foreach($term_datas as $term_data) {
						if($term_data->parent == 1248) $categoria = $term_data->name;
					}
					?>

					<span class="date"><?php echo $categoria; ?>
					</span>
				</p>
				<h1 class="bottom">
					<a class="js-link-to-post"
						id="balloon-post-link-<?php the_ID(); ?>"
						href="<?php the_permalink(); ?>"
						onClick="mapasdevista.linkToPost(this); return false;"><?php the_title(); ?>
					</a>
				</h1>
